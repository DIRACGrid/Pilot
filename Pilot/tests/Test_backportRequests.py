...
# self.ca = 'certs/CAcert.pem'
# self.user_key='certs/user.key'
# self.user_cert='certs/user.crt'
# CA_file = open(self.ca, 'w+')
...
# -----END CERTIFICATE-----''')
# CA_file.close()
# server_cert_file = open(self.server_cert, 'w+')
...
# server_key_file = open(self.server_key, 'w+')
...
# user_cert_file = open(self.user_cert, 'w+')
...
# user_key_file = open(self.user_key, 'w+')
...
# def tearDown(self):
# for f in [self.user_key, self.user_cert, self.server_cert, self.server_key, self.ca]:
# try:
# os.remove(f)
# except OSError:
# pass

...
properties([parameters([string(name: 'projectVersion', defaultValue: 'v6r22p1', description: 'The DIRAC version to install'),
                        ...
                        string(name: 'Tornado_repo', defaultValue: 'wkrzemien', description: 'The Tornado repo only for getting fake credentials'),
                        string(name: 'Tornado_branch', defaultValue: 'master', description: 'The Tornado branch'),
    ...
    withEnv([
        ...
        stage('GET') {
            ...
            dir("$WORKSPACE/TestCode"){
                ...
                """
                sh """
                    git clone https://github.com/${params.Tornado_repo}/PilotLogging_Tornado.git
                    cd PilotLogging_Tornado 
                    git checkout ${params.Tornado_branch}
                    cd ..
                """
